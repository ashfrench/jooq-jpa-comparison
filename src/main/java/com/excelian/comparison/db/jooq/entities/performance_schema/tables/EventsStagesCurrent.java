...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsStagesCurrentNestingEventType;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.EventsStagesCurrentRecord;
...
public class EventsStagesCurrent extends TableImpl<EventsStagesCurrentRecord> {
    ...
    private static final long serialVersionUID = -766422303;
     ...
     */
    public final TableField<EventsStagesCurrentRecord, EventsStagesCurrentNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsStagesCurrentNestingEventType.class), this, "");
