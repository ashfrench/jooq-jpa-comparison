...
import com.excelian.comparison.db.jooq.entities.mysql.tables.records.SlowLogRecord;
...
public class SlowLog extends TableImpl<SlowLogRecord> {
    ...
    private static final long serialVersionUID = -975232533;
     ...
     */
    public final TableField<SlowLogRecord, Timestamp> START_TIME = createField("start_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP(6)", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
