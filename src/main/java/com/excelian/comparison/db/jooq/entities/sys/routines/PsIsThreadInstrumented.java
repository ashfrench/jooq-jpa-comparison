...
public class PsIsThreadInstrumented extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -1801137153;

    /**
     * The parameter <code>sys.ps_is_thread_instrumented.RETURN_VALUE</code>.
     */
    public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR.length(7), false, false);
