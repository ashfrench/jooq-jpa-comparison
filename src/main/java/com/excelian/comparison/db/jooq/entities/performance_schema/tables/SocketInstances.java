...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.SocketInstancesState;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.SocketInstancesRecord;
...
public class SocketInstances extends TableImpl<SocketInstancesRecord> {
    ...
    private static final long serialVersionUID = 762406106;
     ...
     */
    public final TableField<SocketInstancesRecord, SocketInstancesState> STATE = createField("STATE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.SocketInstancesState.class), this, "");
