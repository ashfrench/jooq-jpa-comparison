...
import com.excelian.comparison.db.jooq.entities.sys.enums.SessionTrxAutocommit;
import com.excelian.comparison.db.jooq.entities.sys.enums.SessionTrxState;
import com.excelian.comparison.db.jooq.entities.sys.tables.records.SessionRecord;
...
public class Session extends TableImpl<SessionRecord> {
    ...
    private static final long serialVersionUID = 867490826;
     ...
     */
    public final TableField<SessionRecord, String> FULL_SCAN = createField("full_scan", org.jooq.impl.SQLDataType.VARCHAR.length(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<SessionRecord, SessionTrxState> TRX_STATE = createField("trx_state", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.sys.enums.SessionTrxState.class), this, "");

    /**
     * The column <code>sys.session.trx_autocommit</code>.
     */
    public final TableField<SessionRecord, SessionTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.sys.enums.SessionTrxAutocommit.class), this, "");
