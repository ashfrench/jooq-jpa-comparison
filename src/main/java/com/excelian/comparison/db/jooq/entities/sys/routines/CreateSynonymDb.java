...
public class CreateSynonymDb extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -2058698830;

    /**
     * The parameter <code>sys.create_synonym_db.in_db_name</code>.
     */
    public static final Parameter<String> IN_DB_NAME = createParameter("in_db_name", org.jooq.impl.SQLDataType.VARCHAR.length(64), false, false);

    /**
     * The parameter <code>sys.create_synonym_db.in_synonym</code>.
     */
    public static final Parameter<String> IN_SYNONYM = createParameter("in_synonym", org.jooq.impl.SQLDataType.VARCHAR.length(64), false, false);
