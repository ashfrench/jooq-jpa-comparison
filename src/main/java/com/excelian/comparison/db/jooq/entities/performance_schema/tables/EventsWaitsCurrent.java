...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsWaitsCurrentNestingEventType;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.EventsWaitsCurrentRecord;
...
public class EventsWaitsCurrent extends TableImpl<EventsWaitsCurrentRecord> {
    ...
    private static final long serialVersionUID = 58152234;
     ...
     */
    public final TableField<EventsWaitsCurrentRecord, EventsWaitsCurrentNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsWaitsCurrentNestingEventType.class), this, "");
