...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.ReplicationConnectionStatusServiceState;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.ReplicationConnectionStatusRecord;
...
public class ReplicationConnectionStatus extends TableImpl<ReplicationConnectionStatusRecord> {
    ...
    private static final long serialVersionUID = 1644076607;
     ...
     */
    public final TableField<ReplicationConnectionStatusRecord, ReplicationConnectionStatusServiceState> SERVICE_STATE = createField("SERVICE_STATE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.ReplicationConnectionStatusServiceState.class), this, "");
