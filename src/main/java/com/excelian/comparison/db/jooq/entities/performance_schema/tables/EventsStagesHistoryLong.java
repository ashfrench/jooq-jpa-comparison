...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsStagesHistoryLongNestingEventType;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.EventsStagesHistoryLongRecord;
...
public class EventsStagesHistoryLong extends TableImpl<EventsStagesHistoryLongRecord> {
    ...
    private static final long serialVersionUID = 122338377;
     ...
     */
    public final TableField<EventsStagesHistoryLongRecord, EventsStagesHistoryLongNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsStagesHistoryLongNestingEventType.class), this, "");
