...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$userSummaryRecord;
...
public class X$userSummary extends TableImpl<X$userSummaryRecord> {
    ...
    private static final long serialVersionUID = 1505997095;
     ...
     */
    public final TableField<X$userSummaryRecord, BigDecimal> STATEMENT_AVG_LATENCY = createField("statement_avg_latency", org.jooq.impl.SQLDataType.DECIMAL.precision(65, 4).nullable(false).defaultValue(org.jooq.impl.DSL.inline("0.0000", org.jooq.impl.SQLDataType.DECIMAL)), this, "");
