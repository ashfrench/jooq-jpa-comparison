...
import com.excelian.comparison.db.jooq.entities.sys.enums.X$sessionTrxAutocommit;
import com.excelian.comparison.db.jooq.entities.sys.enums.X$sessionTrxState;
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$sessionRecord;
...
public class X$session extends TableImpl<X$sessionRecord> {
    ...
    private static final long serialVersionUID = -1619249103;
     ...
     */
    public final TableField<X$sessionRecord, String> FULL_SCAN = createField("full_scan", org.jooq.impl.SQLDataType.VARCHAR.length(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<X$sessionRecord, X$sessionTrxState> TRX_STATE = createField("trx_state", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.sys.enums.X$sessionTrxState.class), this, "");

    /**
     * The column <code>sys.x$session.trx_autocommit</code>.
     */
    public final TableField<X$sessionRecord, X$sessionTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.sys.enums.X$sessionTrxAutocommit.class), this, "");
