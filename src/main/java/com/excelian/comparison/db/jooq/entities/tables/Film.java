...
import com.excelian.comparison.db.jooq.entities.enums.FilmRating;
...
public class Film extends TableImpl<FilmRecord> {
    ...
    private static final long serialVersionUID = 1705594748;
     ...
     */
    public final TableField<FilmRecord, FilmRating> RATING = createField("rating", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.enums.FilmRating.class), this, "");
