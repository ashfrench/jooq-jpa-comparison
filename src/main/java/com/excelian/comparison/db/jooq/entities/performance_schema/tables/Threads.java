...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.ThreadsHistory;
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.ThreadsInstrumented;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.ThreadsRecord;
...
public class Threads extends TableImpl<ThreadsRecord> {
    ...
    private static final long serialVersionUID = 1811553225;
     ...
     */
    public final TableField<ThreadsRecord, ThreadsInstrumented> INSTRUMENTED = createField("INSTRUMENTED", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.ThreadsInstrumented.class), this, "");

    /**
     * The column <code>performance_schema.threads.HISTORY</code>.
     */
    public final TableField<ThreadsRecord, ThreadsHistory> HISTORY = createField("HISTORY", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.ThreadsHistory.class), this, "");
