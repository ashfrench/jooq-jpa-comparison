...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.HostCacheHostValidated;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.HostCacheRecord;
...
public class HostCache extends TableImpl<HostCacheRecord> {
    ...
    private static final long serialVersionUID = -1475949863;
     ...
     */
    public final TableField<HostCacheRecord, HostCacheHostValidated> HOST_VALIDATED = createField("HOST_VALIDATED", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.HostCacheHostValidated.class), this, "");
