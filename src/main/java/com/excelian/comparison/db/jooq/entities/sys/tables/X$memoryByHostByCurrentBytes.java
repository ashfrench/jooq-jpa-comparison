...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$memoryByHostByCurrentBytesRecord;
...
public class X$memoryByHostByCurrentBytes extends TableImpl<X$memoryByHostByCurrentBytesRecord> {
    ...
    private static final long serialVersionUID = 1228067942;
