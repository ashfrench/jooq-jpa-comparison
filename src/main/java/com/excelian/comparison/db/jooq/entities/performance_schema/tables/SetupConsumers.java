...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.SetupConsumersEnabled;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.SetupConsumersRecord;
...
public class SetupConsumers extends TableImpl<SetupConsumersRecord> {
    ...
    private static final long serialVersionUID = -564589633;
     ...
     */
    public final TableField<SetupConsumersRecord, SetupConsumersEnabled> ENABLED = createField("ENABLED", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.SetupConsumersEnabled.class), this, "");
