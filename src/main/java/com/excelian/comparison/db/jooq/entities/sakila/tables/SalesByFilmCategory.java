...
import com.excelian.comparison.db.jooq.entities.sakila.tables.records.SalesByFilmCategoryRecord;
...
public class SalesByFilmCategory extends TableImpl<SalesByFilmCategoryRecord> {
    ...
    private static final long serialVersionUID = -1789697989;
     ...
     */
    public final TableField<SalesByFilmCategoryRecord, BigDecimal> TOTAL_SALES = createField("total_sales", org.jooq.impl.SQLDataType.DECIMAL.precision(27, 2), this, "");
