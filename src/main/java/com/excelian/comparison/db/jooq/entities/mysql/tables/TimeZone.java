...
import com.excelian.comparison.db.jooq.entities.mysql.enums.TimeZoneUseLeapSeconds;
...
public class TimeZone extends TableImpl<TimeZoneRecord> {
    ...
    private static final long serialVersionUID = 380800462;
     ...
     */
    public final TableField<TimeZoneRecord, TimeZoneUseLeapSeconds> USE_LEAP_SECONDS = createField("Use_leap_seconds", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.mysql.enums.TimeZoneUseLeapSeconds.class), this, "");
