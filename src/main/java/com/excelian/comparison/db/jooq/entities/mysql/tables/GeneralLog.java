...
import com.excelian.comparison.db.jooq.entities.mysql.tables.records.GeneralLogRecord;
...
public class GeneralLog extends TableImpl<GeneralLogRecord> {
    ...
    private static final long serialVersionUID = -1634361031;
     ...
     */
    public final TableField<GeneralLogRecord, Timestamp> EVENT_TIME = createField("event_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP(6)", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
