...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.SetupTimersTimerName;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.SetupTimersRecord;
...
public class SetupTimers extends TableImpl<SetupTimersRecord> {
    ...
    private static final long serialVersionUID = 1876790698;
     ...
     */
    public final TableField<SetupTimersRecord, SetupTimersTimerName> TIMER_NAME = createField("TIMER_NAME", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.SetupTimersTimerName.class), this, "");
