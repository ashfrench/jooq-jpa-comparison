...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.SchemaRedundantIndexesRecord;
...
public class SchemaRedundantIndexes extends TableImpl<SchemaRedundantIndexesRecord> {
    ...
    private static final long serialVersionUID = -1325415312;
     ...
     */
    public final TableField<SchemaRedundantIndexesRecord, String> TABLE_SCHEMA = createField("table_schema", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>sys.schema_redundant_indexes.table_name</code>.
     */
    public final TableField<SchemaRedundantIndexesRecord, String> TABLE_NAME = createField("table_name", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>sys.schema_redundant_indexes.redundant_index_name</code>.
     */
    public final TableField<SchemaRedundantIndexesRecord, String> REDUNDANT_INDEX_NAME = createField("redundant_index_name", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<SchemaRedundantIndexesRecord, String> DOMINANT_INDEX_NAME = createField("dominant_index_name", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
