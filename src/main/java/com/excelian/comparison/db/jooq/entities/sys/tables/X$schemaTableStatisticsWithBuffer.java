...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$schemaTableStatisticsWithBufferRecord;
...
public class X$schemaTableStatisticsWithBuffer extends TableImpl<X$schemaTableStatisticsWithBufferRecord> {
    ...
    private static final long serialVersionUID = 40355343;
