...
import com.excelian.comparison.db.jooq.entities.mysql.enums.EventIntervalField;
import com.excelian.comparison.db.jooq.entities.mysql.enums.EventOnCompletion;
import com.excelian.comparison.db.jooq.entities.mysql.enums.EventStatus;
...
public class Event extends TableImpl<EventRecord> {
    ...
    private static final long serialVersionUID = -1695558911;
     ...
     */
    public final TableField<EventRecord, EventIntervalField> INTERVAL_FIELD = createField("interval_field", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.mysql.enums.EventIntervalField.class), this, "");
     ...
     */
    public final TableField<EventRecord, EventStatus> STATUS = createField("status", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.mysql.enums.EventStatus.class), this, "");

    /**
     * The column <code>mysql.event.on_completion</code>.
     */
    public final TableField<EventRecord, EventOnCompletion> ON_COMPLETION = createField("on_completion", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.mysql.enums.EventOnCompletion.class), this, "");
