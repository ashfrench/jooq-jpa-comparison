...
import com.excelian.comparison.db.jooq.entities.information_schema.tables.records.ProcesslistRecord;
...
public class Processlist extends TableImpl<ProcesslistRecord> {
    ...
    private static final long serialVersionUID = -1776601399;
     ...
     */
    public final TableField<ProcesslistRecord, String> USER = createField("USER", org.jooq.impl.SQLDataType.VARCHAR.length(32).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
