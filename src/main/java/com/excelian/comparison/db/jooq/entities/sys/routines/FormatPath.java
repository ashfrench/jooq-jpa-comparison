...
public class FormatPath extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = 1361528485;

    /**
     * The parameter <code>sys.format_path.RETURN_VALUE</code>.
     */
    public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR.length(512), false, false);

    /**
     * The parameter <code>sys.format_path.path</code>.
     */
    public static final Parameter<String> PATH = createParameter("path", org.jooq.impl.SQLDataType.VARCHAR.length(512), false, false);
