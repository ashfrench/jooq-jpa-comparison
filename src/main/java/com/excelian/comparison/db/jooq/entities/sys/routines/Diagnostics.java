...
public class Diagnostics extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -321857552;
     ...
     */
    public static final Parameter<String> IN_AUTO_CONFIG = createParameter("in_auto_config", org.jooq.impl.SQLDataType.VARCHAR.length(7), false, false);
