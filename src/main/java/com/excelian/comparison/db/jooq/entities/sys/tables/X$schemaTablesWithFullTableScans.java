...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$schemaTablesWithFullTableScansRecord;
...
public class X$schemaTablesWithFullTableScans extends TableImpl<X$schemaTablesWithFullTableScansRecord> {
    ...
    private static final long serialVersionUID = 754215311;
