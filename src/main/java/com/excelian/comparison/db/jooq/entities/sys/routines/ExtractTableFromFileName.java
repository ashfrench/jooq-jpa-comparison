...
public class ExtractTableFromFileName extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -1768090588;

    /**
     * The parameter <code>sys.extract_table_from_file_name.RETURN_VALUE</code>.
     */
    public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR.length(64), false, false);
