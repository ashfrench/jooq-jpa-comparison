...
import com.excelian.comparison.db.jooq.entities.tables.records.FilmListRecord;
...
public class FilmList extends TableImpl<FilmListRecord> {
    ...
    private static final long serialVersionUID = -400295644;
     ...
     */
    public final TableField<FilmListRecord, FilmListRating> RATING = createField("rating", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.enums.FilmListRating.class), this, "");
