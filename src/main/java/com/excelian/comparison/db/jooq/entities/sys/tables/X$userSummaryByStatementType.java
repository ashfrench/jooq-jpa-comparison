...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$userSummaryByStatementTypeRecord;
...
public class X$userSummaryByStatementType extends TableImpl<X$userSummaryByStatementTypeRecord> {
    ...
    private static final long serialVersionUID = 1367163108;
