...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$psSchemaTableStatisticsIoRecord;
...
public class X$psSchemaTableStatisticsIo extends TableImpl<X$psSchemaTableStatisticsIoRecord> {
    ...
    private static final long serialVersionUID = 676689535;
