...
public class GetCustomerBalance extends AbstractRoutine<BigDecimal> {
    ...
    private static final long serialVersionUID = 192624186;

    /**
     * The parameter <code>sakila.get_customer_balance.RETURN_VALUE</code>.
     */
    public static final Parameter<BigDecimal> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.DECIMAL.precision(5, 2), false, false);
