...
import com.excelian.comparison.db.jooq.entities.sys.enums.X$processlistTrxAutocommit;
import com.excelian.comparison.db.jooq.entities.sys.enums.X$processlistTrxState;
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$processlistRecord;
...
public class X$processlist extends TableImpl<X$processlistRecord> {
    ...
    private static final long serialVersionUID = -949855576;
     ...
     */
    public final TableField<X$processlistRecord, String> FULL_SCAN = createField("full_scan", org.jooq.impl.SQLDataType.VARCHAR.length(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<X$processlistRecord, X$processlistTrxState> TRX_STATE = createField("trx_state", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.sys.enums.X$processlistTrxState.class), this, "");

    /**
     * The column <code>sys.x$processlist.trx_autocommit</code>.
     */
    public final TableField<X$processlistRecord, X$processlistTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.sys.enums.X$processlistTrxAutocommit.class), this, "");
