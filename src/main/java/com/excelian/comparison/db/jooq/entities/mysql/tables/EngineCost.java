...
public class EngineCost extends TableImpl<EngineCostRecord> {
    ...
    private static final long serialVersionUID = 67377951;
     ...
     */
    public final TableField<EngineCostRecord, Timestamp> LAST_UPDATE = createField("last_update", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
