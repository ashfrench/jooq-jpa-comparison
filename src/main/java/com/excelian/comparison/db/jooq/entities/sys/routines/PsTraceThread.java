...
public class PsTraceThread extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -20022367;
     ...
     */
    public static final Parameter<String> IN_OUTFILE = createParameter("in_outfile", org.jooq.impl.SQLDataType.VARCHAR.length(255), false, false);

    /**
     * The parameter <code>sys.ps_trace_thread.in_max_runtime</code>.
     */
    public static final Parameter<BigDecimal> IN_MAX_RUNTIME = createParameter("in_max_runtime", org.jooq.impl.SQLDataType.DECIMAL.precision(20, 2), false, false);

    /**
     * The parameter <code>sys.ps_trace_thread.in_interval</code>.
     */
    public static final Parameter<BigDecimal> IN_INTERVAL = createParameter("in_interval", org.jooq.impl.SQLDataType.DECIMAL.precision(20, 2), false, false);
