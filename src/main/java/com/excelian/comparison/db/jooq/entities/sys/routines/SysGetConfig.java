...
public class SysGetConfig extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -1947886226;

    /**
     * The parameter <code>sys.sys_get_config.RETURN_VALUE</code>.
     */
    public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR.length(128), false, false);

    /**
     * The parameter <code>sys.sys_get_config.in_variable_name</code>.
     */
    public static final Parameter<String> IN_VARIABLE_NAME = createParameter("in_variable_name", org.jooq.impl.SQLDataType.VARCHAR.length(128), false, false);

    /**
     * The parameter <code>sys.sys_get_config.in_default_value</code>.
     */
    public static final Parameter<String> IN_DEFAULT_VALUE = createParameter("in_default_value", org.jooq.impl.SQLDataType.VARCHAR.length(128), false, false);
