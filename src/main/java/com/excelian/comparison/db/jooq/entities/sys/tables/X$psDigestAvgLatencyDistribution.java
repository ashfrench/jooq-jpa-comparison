...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$psDigestAvgLatencyDistributionRecord;
...
public class X$psDigestAvgLatencyDistribution extends TableImpl<X$psDigestAvgLatencyDistributionRecord> {
    ...
    private static final long serialVersionUID = 964685679;
