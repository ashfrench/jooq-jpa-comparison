...
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.ReplicationApplierStatusByCoordinatorRecord;
...
public class ReplicationApplierStatusByCoordinator extends TableImpl<ReplicationApplierStatusByCoordinatorRecord> {
    ...
    private static final long serialVersionUID = 689127244;
     ...
     */
    public final TableField<ReplicationApplierStatusByCoordinatorRecord, ReplicationApplierStatusByCoordinatorServiceState> SERVICE_STATE = createField("SERVICE_STATE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.ReplicationApplierStatusByCoordinatorServiceState.class), this, "");
     ...
     */
    public final TableField<ReplicationApplierStatusByCoordinatorRecord, Timestamp> LAST_ERROR_TIMESTAMP = createField("LAST_ERROR_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
