...
public class ColumnsPriv extends TableImpl<ColumnsPrivRecord> {
    ...
    private static final long serialVersionUID = 496379351;
     ...
     */
    public final TableField<ColumnsPrivRecord, String> USER = createField("User", org.jooq.impl.SQLDataType.CHAR.length(32).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
