...
import com.excelian.comparison.db.jooq.entities.mysql.enums.ProcIsDeterministic;
import com.excelian.comparison.db.jooq.entities.mysql.enums.ProcLanguage;
import com.excelian.comparison.db.jooq.entities.mysql.enums.ProcSecurityType;
import com.excelian.comparison.db.jooq.entities.mysql.enums.ProcSqlDataAccess;
import com.excelian.comparison.db.jooq.entities.mysql.enums.ProcType;
...
public class Proc extends TableImpl<ProcRecord> {
    ...
    private static final long serialVersionUID = -410209683;
     ...
     */
    public final TableField<ProcRecord, ProcType> TYPE = createField("type", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.mysql.enums.ProcType.class), this, "");
     ...
     */
    public final TableField<ProcRecord, ProcLanguage> LANGUAGE = createField("language", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.mysql.enums.ProcLanguage.class), this, "");

    /**
     * The column <code>mysql.proc.sql_data_access</code>.
     */
    public final TableField<ProcRecord, ProcSqlDataAccess> SQL_DATA_ACCESS = createField("sql_data_access", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.mysql.enums.ProcSqlDataAccess.class), this, "");

    /**
     * The column <code>mysql.proc.is_deterministic</code>.
     */
    public final TableField<ProcRecord, ProcIsDeterministic> IS_DETERMINISTIC = createField("is_deterministic", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.mysql.enums.ProcIsDeterministic.class), this, "");

    /**
     * The column <code>mysql.proc.security_type</code>.
     */
    public final TableField<ProcRecord, ProcSecurityType> SECURITY_TYPE = createField("security_type", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.mysql.enums.ProcSecurityType.class), this, "");
