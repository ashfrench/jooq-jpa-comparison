...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsWaitsHistoryLongNestingEventType;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.EventsWaitsHistoryLongRecord;
...
public class EventsWaitsHistoryLong extends TableImpl<EventsWaitsHistoryLongRecord> {
    ...
    private static final long serialVersionUID = 1689034193;
     ...
     */
    public final TableField<EventsWaitsHistoryLongRecord, EventsWaitsHistoryLongNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsWaitsHistoryLongNestingEventType.class), this, "");
