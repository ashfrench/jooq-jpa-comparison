...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$memoryByUserByCurrentBytesRecord;
...
public class X$memoryByUserByCurrentBytes extends TableImpl<X$memoryByUserByCurrentBytesRecord> {
    ...
    private static final long serialVersionUID = 746513513;
     ...
     */
    public final TableField<X$memoryByUserByCurrentBytesRecord, BigDecimal> CURRENT_AVG_ALLOC = createField("current_avg_alloc", org.jooq.impl.SQLDataType.DECIMAL.precision(45, 4).nullable(false).defaultValue(org.jooq.impl.DSL.inline("0.0000", org.jooq.impl.SQLDataType.DECIMAL)), this, "");
