...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$ioGlobalByWaitByBytesRecord;
...
public class X$ioGlobalByWaitByBytes extends TableImpl<X$ioGlobalByWaitByBytesRecord> {
    ...
    private static final long serialVersionUID = 1841303313;
     ...
     */
    public final TableField<X$ioGlobalByWaitByBytesRecord, BigDecimal> AVG_READ = createField("avg_read", org.jooq.impl.SQLDataType.DECIMAL.precision(23, 4).nullable(false).defaultValue(org.jooq.impl.DSL.inline("0.0000", org.jooq.impl.SQLDataType.DECIMAL)), this, "");
     ...
     */
    public final TableField<X$ioGlobalByWaitByBytesRecord, BigDecimal> AVG_WRITTEN = createField("avg_written", org.jooq.impl.SQLDataType.DECIMAL.precision(23, 4).nullable(false).defaultValue(org.jooq.impl.DSL.inline("0.0000", org.jooq.impl.SQLDataType.DECIMAL)), this, "");
