...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$waitClassesGlobalByLatencyRecord;
...
public class X$waitClassesGlobalByLatency extends TableImpl<X$waitClassesGlobalByLatencyRecord> {
    ...
    private static final long serialVersionUID = -705879658;
