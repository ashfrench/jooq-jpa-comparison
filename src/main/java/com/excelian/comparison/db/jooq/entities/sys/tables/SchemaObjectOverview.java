...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.SchemaObjectOverviewRecord;
...
public class SchemaObjectOverview extends TableImpl<SchemaObjectOverviewRecord> {
    ...
    private static final long serialVersionUID = 1329922559;
     ...
     */
    public final TableField<SchemaObjectOverviewRecord, String> DB = createField("db", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
