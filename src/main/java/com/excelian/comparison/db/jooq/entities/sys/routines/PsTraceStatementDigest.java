...
public class PsTraceStatementDigest extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = 1151772863;

    /**
     * The parameter <code>sys.ps_trace_statement_digest.in_digest</code>.
     */
    public static final Parameter<String> IN_DIGEST = createParameter("in_digest", org.jooq.impl.SQLDataType.VARCHAR.length(32), false, false);
     ...
     */
    public static final Parameter<BigDecimal> IN_INTERVAL = createParameter("in_interval", org.jooq.impl.SQLDataType.DECIMAL.precision(2, 2), false, false);
