...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$hostSummaryByStatementLatencyRecord;
...
public class X$hostSummaryByStatementLatency extends TableImpl<X$hostSummaryByStatementLatencyRecord> {
    ...
    private static final long serialVersionUID = -1829648259;
