...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.SetupActorsEnabled;
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.SetupActorsHistory;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.SetupActorsRecord;
...
public class SetupActors extends TableImpl<SetupActorsRecord> {
    ...
    private static final long serialVersionUID = -305538764;
     ...
     */
    public final TableField<SetupActorsRecord, SetupActorsEnabled> ENABLED = createField("ENABLED", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.SetupActorsEnabled.class), this, "");

    /**
     * The column <code>performance_schema.setup_actors.HISTORY</code>.
     */
    public final TableField<SetupActorsRecord, SetupActorsHistory> HISTORY = createField("HISTORY", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.SetupActorsHistory.class), this, "");
