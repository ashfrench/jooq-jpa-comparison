...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsCurrentAccessMode;
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsCurrentAutocommit;
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsCurrentNestingEventType;
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsCurrentState;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.EventsTransactionsCurrentRecord;
...
public class EventsTransactionsCurrent extends TableImpl<EventsTransactionsCurrentRecord> {
    ...
    private static final long serialVersionUID = -945349763;
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentState> STATE = createField("STATE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsCurrentState.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentAccessMode> ACCESS_MODE = createField("ACCESS_MODE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsCurrentAccessMode.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentAutocommit> AUTOCOMMIT = createField("AUTOCOMMIT", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsCurrentAutocommit.class), this, "");
