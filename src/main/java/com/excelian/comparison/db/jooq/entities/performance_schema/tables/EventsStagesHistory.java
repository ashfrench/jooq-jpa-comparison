...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsStagesHistoryNestingEventType;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.EventsStagesHistoryRecord;
...
public class EventsStagesHistory extends TableImpl<EventsStagesHistoryRecord> {
    ...
    private static final long serialVersionUID = 1967822213;
     ...
     */
    public final TableField<EventsStagesHistoryRecord, EventsStagesHistoryNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsStagesHistoryNestingEventType.class), this, "");
