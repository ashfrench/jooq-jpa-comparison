...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$waitClassesGlobalByAvgLatencyRecord;
...
public class X$waitClassesGlobalByAvgLatency extends TableImpl<X$waitClassesGlobalByAvgLatencyRecord> {
    ...
    private static final long serialVersionUID = 115528290;
