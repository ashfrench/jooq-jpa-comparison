...
public class PsIsAccountEnabled extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = 558087100;

    /**
     * The parameter <code>sys.ps_is_account_enabled.RETURN_VALUE</code>.
     */
    public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR.length(3), false, false);

    /**
     * The parameter <code>sys.ps_is_account_enabled.in_host</code>.
     */
    public static final Parameter<String> IN_HOST = createParameter("in_host", org.jooq.impl.SQLDataType.VARCHAR.length(60), false, false);

    /**
     * The parameter <code>sys.ps_is_account_enabled.in_user</code>.
     */
    public static final Parameter<String> IN_USER = createParameter("in_user", org.jooq.impl.SQLDataType.VARCHAR.length(32), false, false);
