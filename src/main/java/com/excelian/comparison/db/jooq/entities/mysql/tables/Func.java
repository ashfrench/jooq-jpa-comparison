...
import com.excelian.comparison.db.jooq.entities.mysql.enums.FuncType;
...
public class Func extends TableImpl<FuncRecord> {
    ...
    private static final long serialVersionUID = 2106347938;
     ...
     */
    public final TableField<FuncRecord, FuncType> TYPE = createField("type", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.mysql.enums.FuncType.class), this, "");
