...
public class PsIsInstrumentDefaultEnabled extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = 1884109148;
     ...
     */
    public static final Parameter<String> IN_INSTRUMENT = createParameter("in_instrument", org.jooq.impl.SQLDataType.VARCHAR.length(128), false, false);
