...
import com.excelian.comparison.db.jooq.entities.sys.Keys;
import com.excelian.comparison.db.jooq.entities.sys.Sys;
import com.excelian.comparison.db.jooq.entities.sys.tables.records.SysConfigRecord;
...
public class SysConfig extends TableImpl<SysConfigRecord> {
    ...
    private static final long serialVersionUID = -802929111;
     ...
     */
    public final TableField<SysConfigRecord, Timestamp> SET_TIME = createField("set_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
