...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryLongAccessMode;
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryLongAutocommit;
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryLongNestingEventType;
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryLongState;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.EventsTransactionsHistoryLongRecord;
...
public class EventsTransactionsHistoryLong extends TableImpl<EventsTransactionsHistoryLongRecord> {
    ...
    private static final long serialVersionUID = -1034058650;
     ...
     */
    public final TableField<EventsTransactionsHistoryLongRecord, EventsTransactionsHistoryLongState> STATE = createField("STATE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryLongState.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsHistoryLongRecord, EventsTransactionsHistoryLongAccessMode> ACCESS_MODE = createField("ACCESS_MODE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryLongAccessMode.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsHistoryLongRecord, EventsTransactionsHistoryLongAutocommit> AUTOCOMMIT = createField("AUTOCOMMIT", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryLongAutocommit.class), this, "");
