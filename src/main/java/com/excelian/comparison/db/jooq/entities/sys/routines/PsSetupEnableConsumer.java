...
public class PsSetupEnableConsumer extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -1961839303;

    /**
     * The parameter <code>sys.ps_setup_enable_consumer.consumer</code>.
     */
    public static final Parameter<String> CONSUMER = createParameter("consumer", org.jooq.impl.SQLDataType.VARCHAR.length(128), false, false);
