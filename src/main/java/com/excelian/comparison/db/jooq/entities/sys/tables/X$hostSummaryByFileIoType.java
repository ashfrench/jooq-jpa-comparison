...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$hostSummaryByFileIoTypeRecord;
...
public class X$hostSummaryByFileIoType extends TableImpl<X$hostSummaryByFileIoTypeRecord> {
    ...
    private static final long serialVersionUID = -1182103899;
