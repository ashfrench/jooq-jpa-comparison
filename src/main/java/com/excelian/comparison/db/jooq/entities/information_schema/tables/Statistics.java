...
import com.excelian.comparison.db.jooq.entities.information_schema.tables.records.StatisticsRecord;
...
public class Statistics extends TableImpl<StatisticsRecord> {
    ...
    private static final long serialVersionUID = 627926869;
