...
import com.excelian.comparison.db.jooq.entities.sys.enums.ProcesslistTrxAutocommit;
import com.excelian.comparison.db.jooq.entities.sys.enums.ProcesslistTrxState;
import com.excelian.comparison.db.jooq.entities.sys.tables.records.ProcesslistRecord;
...
public class Processlist extends TableImpl<ProcesslistRecord> {
    ...
    private static final long serialVersionUID = 2110855561;
     ...
     */
    public final TableField<ProcesslistRecord, ProcesslistTrxState> TRX_STATE = createField("trx_state", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.sys.enums.ProcesslistTrxState.class), this, "");

    /**
     * The column <code>sys.processlist.trx_autocommit</code>.
     */
    public final TableField<ProcesslistRecord, ProcesslistTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.sys.enums.ProcesslistTrxAutocommit.class), this, "");
