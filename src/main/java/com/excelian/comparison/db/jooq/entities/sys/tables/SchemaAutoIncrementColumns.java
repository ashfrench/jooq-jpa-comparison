...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.SchemaAutoIncrementColumnsRecord;
...
public class SchemaAutoIncrementColumns extends TableImpl<SchemaAutoIncrementColumnsRecord> {
    ...
    private static final long serialVersionUID = -1109609466;
     ...
     */
    public final TableField<SchemaAutoIncrementColumnsRecord, String> TABLE_SCHEMA = createField("table_schema", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>sys.schema_auto_increment_columns.table_name</code>.
     */
    public final TableField<SchemaAutoIncrementColumnsRecord, String> TABLE_NAME = createField("table_name", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>sys.schema_auto_increment_columns.column_name</code>.
     */
    public final TableField<SchemaAutoIncrementColumnsRecord, String> COLUMN_NAME = createField("column_name", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>sys.schema_auto_increment_columns.data_type</code>.
     */
    public final TableField<SchemaAutoIncrementColumnsRecord, String> DATA_TYPE = createField("data_type", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
