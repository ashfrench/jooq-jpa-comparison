...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$statementsWithErrorsOrWarningsRecord;
...
public class X$statementsWithErrorsOrWarnings extends TableImpl<X$statementsWithErrorsOrWarningsRecord> {
    ...
    private static final long serialVersionUID = 1486185623;
     ...
     */
    public final TableField<X$statementsWithErrorsOrWarningsRecord, BigDecimal> ERROR_PCT = createField("error_pct", org.jooq.impl.SQLDataType.DECIMAL.precision(27, 4).nullable(false).defaultValue(org.jooq.impl.DSL.inline("0.0000", org.jooq.impl.SQLDataType.DECIMAL)), this, "");
     ...
     */
    public final TableField<X$statementsWithErrorsOrWarningsRecord, BigDecimal> WARNING_PCT = createField("warning_pct", org.jooq.impl.SQLDataType.DECIMAL.precision(27, 4).nullable(false).defaultValue(org.jooq.impl.DSL.inline("0.0000", org.jooq.impl.SQLDataType.DECIMAL)), this, "");
