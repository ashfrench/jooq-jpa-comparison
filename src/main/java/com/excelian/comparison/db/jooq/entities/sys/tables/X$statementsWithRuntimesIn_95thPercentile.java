...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$statementsWithRuntimesIn_95thPercentileRecord;
...
public class X$statementsWithRuntimesIn_95thPercentile extends TableImpl<X$statementsWithRuntimesIn_95thPercentileRecord> {
    ...
    private static final long serialVersionUID = -1543776858;
     ...
     */
    public final TableField<X$statementsWithRuntimesIn_95thPercentileRecord, String> FULL_SCAN = createField("full_scan", org.jooq.impl.SQLDataType.VARCHAR.length(1).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
