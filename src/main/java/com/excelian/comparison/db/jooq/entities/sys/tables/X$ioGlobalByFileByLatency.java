...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$ioGlobalByFileByLatencyRecord;
...
public class X$ioGlobalByFileByLatency extends TableImpl<X$ioGlobalByFileByLatencyRecord> {
    ...
    private static final long serialVersionUID = 1903892439;
