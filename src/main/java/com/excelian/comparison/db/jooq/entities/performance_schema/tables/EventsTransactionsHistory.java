...
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryAccessMode;
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryAutocommit;
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryNestingEventType;
import com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryState;
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.EventsTransactionsHistoryRecord;
...
public class EventsTransactionsHistory extends TableImpl<EventsTransactionsHistoryRecord> {
    ...
    private static final long serialVersionUID = 1661876618;
     ...
     */
    public final TableField<EventsTransactionsHistoryRecord, EventsTransactionsHistoryState> STATE = createField("STATE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryState.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsHistoryRecord, EventsTransactionsHistoryAccessMode> ACCESS_MODE = createField("ACCESS_MODE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryAccessMode.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsHistoryRecord, EventsTransactionsHistoryAutocommit> AUTOCOMMIT = createField("AUTOCOMMIT", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryAutocommit.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsHistoryRecord, EventsTransactionsHistoryNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(com.excelian.comparison.db.jooq.entities.performance_schema.enums.EventsTransactionsHistoryNestingEventType.class), this, "");
