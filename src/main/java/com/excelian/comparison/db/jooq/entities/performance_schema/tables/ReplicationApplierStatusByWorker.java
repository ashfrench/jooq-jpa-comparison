...
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.ReplicationApplierStatusByWorkerRecord;
...
public class ReplicationApplierStatusByWorker extends TableImpl<ReplicationApplierStatusByWorkerRecord> {
    ...
    private static final long serialVersionUID = -449051064;
     ...
     */
    public final TableField<ReplicationApplierStatusByWorkerRecord, Timestamp> LAST_ERROR_TIMESTAMP = createField("LAST_ERROR_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
