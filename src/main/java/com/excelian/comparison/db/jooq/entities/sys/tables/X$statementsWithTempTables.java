...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$statementsWithTempTablesRecord;
...
public class X$statementsWithTempTables extends TableImpl<X$statementsWithTempTablesRecord> {
    ...
    private static final long serialVersionUID = 816983138;
