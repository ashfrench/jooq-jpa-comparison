...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$statementAnalysisRecord;
...
public class X$statementAnalysis extends TableImpl<X$statementAnalysisRecord> {
    ...
    private static final long serialVersionUID = 1919443597;
     ...
     */
    public final TableField<X$statementAnalysisRecord, String> FULL_SCAN = createField("full_scan", org.jooq.impl.SQLDataType.VARCHAR.length(1).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
