...
import com.excelian.comparison.db.jooq.entities.sys.tables.records.X$hostSummaryByStatementTypeRecord;
...
public class X$hostSummaryByStatementType extends TableImpl<X$hostSummaryByStatementTypeRecord> {
    ...
    private static final long serialVersionUID = 1862883081;
