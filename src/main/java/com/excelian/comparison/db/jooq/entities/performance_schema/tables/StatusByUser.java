...
import com.excelian.comparison.db.jooq.entities.performance_schema.tables.records.StatusByUserRecord;
...
public class StatusByUser extends TableImpl<StatusByUserRecord> {
    ...
    private static final long serialVersionUID = -235190027;
